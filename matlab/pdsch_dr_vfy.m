...
%% 激励写入文件
if WriteFile
    write2file_fcn('../vfy/pdsch_dr_tb_work/code_word_even.txt',cw_eve);
    write2file_fcn('../vfy/pdsch_dr_tb_work/code_word_odd.txt' ,cw_odd);
end
...
%% 激励写入文件
if WriteFile
    write2file_fcn('../vfy/pdsch_dr_tb_work/iq_data.txt',(dl_data).');
end
...
if ReloadData
    datafile1='../vfy/pdsch_dr_tb_work/des_tx_data.txt';
    datafile2='../vfy/pdsch_dr_tb_work/des_rx_data.txt';
    datafile3='../vfy/pdsch_dr_tb_work/des_unzip_data.txt';
    datafile4='../vfy/pdsch_dr_tb_work/des_beams_data.txt';
    datafile5='../vfy/pdsch_dr_tb_work/des_beams_pwr.txt';
    datafile6='../vfy/pdsch_dr_tb_work/des_beams_sort.txt';
    datafile7='../vfy/pdsch_dr_tb_work/des_beams_idx.txt';
...
% 分离出发送端的奇偶天线数据（单Lane 8天线）
ant4_tx_eve = sim_tx_data((2*symbol_id-2)*numCarriers+1 : (2*symbol_id-1)*numCarriers, :);
ant4_tx_odd = sim_tx_data((2*symbol_id-1)*numCarriers+1 : (2*symbol_id-0)*numCarriers, :);
