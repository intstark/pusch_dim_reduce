...
%% 激励写入文件
if WriteFile
    write2file_fcn('../sim/cpri_rxdata_8lanes_tb_work/iq_data.txt',(uint_iq).');
end
...
% datafile1='../sim/cpri_rxdata_8lanes_tb_work/ant_data.txt';
...
datafile1='../sim/cpri_rxdata_8lanes_tb_work/beam_data_even.txt';
datafile2='../sim/cpri_rxdata_8lanes_tb_work/beam_data_odd.txt';
datafile3='../sim/cpri_rxdata_8lanes_tb_work/beam_data.txt';
