...
err_CpriOut_RbAgc = rbgout_cprs_reverse - rb_agc_cpri_out;
err_CpriOut_RbAgc_max=max(abs(err_CpriOut_RbAgc),[],[1,2]);
fprintf('CPRI输出RB AGC比较(MAX):\t err_CpriOut_RbAgc_max=\t%d\n',err_CpriOut_RbAgc_max);
